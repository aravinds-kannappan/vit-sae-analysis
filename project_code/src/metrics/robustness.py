...
def evaluate_robustness_jpeg(model, processor, normal_dataset, shifted_dataset, RPI = False, magnitude = 1.0):
    # Prepare dataloaders for the JPEG-corrupted and normal datasets
    
    dataloader_shifted = prep_data(shifted_dataset,processor)
    dataloader_normal = prep_data(normal_dataset,processor)
